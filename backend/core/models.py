...
# core/models.py or operations/models.py

product = models.ForeignKey(Product, on_delete=models.CASCADE, related_name='inbound_core')  # or 'inbound_ops'
supplier = models.ForeignKey(Supplier, on_delete=models.CASCADE, related_name='supplier_core')
customer = models.ForeignKey(Customer, on_delete=models.CASCADE, related_name='customer_core')
# Ensure the related_name is unique across models to avoid conflicts